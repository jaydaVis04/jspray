...
- [Architecture](architecture.md): pipeline, identity, persistence, and security boundaries
- [Bifrost research](bifrost-research.md): verified upstream behavior and backend decision
- [Current scope](scope.md): authoritative included and excluded functionality
